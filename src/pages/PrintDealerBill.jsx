        ...
        <div style={{ border: '2px solid black' }}>
          ...
          <div style={{ borderTop: '1px solid black', display: 'flex' }}>
            ...
            <div style={{ width: '300px' }}>
              ...
              <div style={{ display: 'flex', borderBottom: '1px solid black' }}>
                <div style={{ flex: 1, padding: '5px', borderRight: '1px solid black' }}>CGST {bill.gst_percentage / 2}%</div>
                <div style={{ width: '100px', padding: '5px', textAlign: 'right' }}>{bill.cgst.toFixed(2)}</div>
              </div>
              <div style={{ display: 'flex', borderBottom: '1px solid black' }}>
                <div style={{ flex: 1, padding: '5px', borderRight: '1px solid black' }}>SGST {bill.gst_percentage / 2}%</div>
                <div style={{ width: '100px', padding: '5px', textAlign: 'right' }}>{bill.sgst.toFixed(2)}</div>
              </div>
              <div style={{ display: 'flex', borderBottom: '1px solid black' }}>
              ...
              <div style={{ display: 'flex', fontWeight: 'bold', backgroundColor: '#f0f0f0' }}>
                ...
                <div style={{ width: '100px', padding: '5px', textAlign: 'right' }}>{bill.grand_total.toFixed(2)}</div>
              </div>
            </div>
          </div>
